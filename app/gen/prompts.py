...
- 下拉选择写成「在【字段名】中选择【选项】」或拆成「点击【字段名】下拉」+「选择【选项】」；禁止「某下拉框选择【选项】」这种把「下拉框」当成页面文案的写法
...
- 下拉选择必须写成可执行两段语义之一：「点击【单位】下拉」+「选择【汉东省院】」分两步，或一步内写「在【单位】中选择【汉东省院】」。禁止写「单位下拉框选择【…】」（执行端会误把「下拉框」当页面文案）。
