...
[
  ...
  {"fp_name":"客户列表组合查询","title":"姓名+状态组合查询","module":"客户管理——客户列表","priority":"P0","precondition":"已打开客户列表且存在匹配与不匹配数据","steps":["在【姓名】输入张三","在【状态】选择【启用】","点击【查询】"],"expected":["列表仅含姓名匹配且状态为启用的记录","不出现仅满足单条件的记录"],"scenario_type":"组合查询"}
]
"""
